...
<body>
    ...
    <div id="contact" class="container my-5">
        <div class="p-5 text-center bg-body-tertiary rounded-3">
            ...
            <div class="mt-3">
                <a class="btn btn-outline-primary btn-contact mx-3" href="https://www.linkedin.com/in/luis-leguizamonl/">
                ...
                <a class="btn btn-outline-dark btn-contact mx-3" href="https://github.com/luisleguizamon">

...
$techStack = [
    ...
    '<svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" preserveAspectRatio="xMinYMin meet" viewBox="0 0 256 256" id="logoLaravel">
        <g fill="#00000"> <!-- Change the fill color here -->
    ...
    'PHP' =>
    '<svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 24 24" id="php">
        <path fill="#00000" d="M12 18.5c6.626 0 12-2.908 12-6.5 0-3.591-5.374-6.5-12-6.5S0 8.408 0 12s5.374 6.5 12 6.5z"></path>
    ...
    'JavaScript' =>
    '<svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 512 512" id="javascript">
        <rect width="512" height="512" fill="#00000" rx="15%"></rect>
